...
pub struct F1 {
    /// Vec of tuple of offset and Vec of bytes
    data: Vec<(usize, SendData)>,
    /// register write operations performed. Vec of offset and values
...
//#[cfg(feature = "f1")]
impl F1 {
    // TODO: find if slot and offset are relevant
    pub fn new(_slot: i32, _offset: i32) -> Result<Self> {
...
#[cfg(feature = "f1")]
impl Fpga for F1 {
    fn receive(&mut self, _buffer: &mut ReceiveBuffer) {
        // // blocking
    ...
    fn read_register(&self, _index: u32) -> u32 {
        // let offset = index << 2;
